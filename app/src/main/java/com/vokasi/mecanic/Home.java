...
public class Home extends Fragment implements FetchAddress.OnTaskCompleted {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        namaUser = (TextView) homeView.findViewById(R.id.namaUser);
        lokasiUser = (TextView) homeView.findViewById(R.id.lokasiUser);
        searchBar = (TextView) homeView.findViewById(R.id.searchBar);
        btnLokasi = (ImageButton) homeView.findViewById(R.id.btnLocation);
        fotoProfil = (ImageView) homeView.findViewById(R.id.fotoProfil);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.getChildrenCount()>0) {
                    for (DataSnapshot ds : snapshot.getChildren()) {
                        ...
                        namaUser.setText("Halo," + namaDepan + namaAkhir);
                    }
                }
            }
