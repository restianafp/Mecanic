...
public class RegistCustomer extends AppCompatActivity {
    ...
    private EditText emailEt, usernameEt, passwordEt, confirmPassEt, firstNameEt, lastNameEt, phoneNumEt;
    ...
    private String accType, email, username, password, confirmPassword, firstName, lastName, phoneNum, photo_uri;
    ...
    private void savedFirebaseData() {
       ...
       UserCust userData = new UserCust(accType, email, username, password, confirmPassword,
               firstName, lastName, phoneNum, photo_uri);
    ...
    private void notifySuccess() {
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this,
                    CHANNEL_ID).setContentTitle(getResources().getText(R.string.app_name)).setSmallIcon(R.drawable.icon)
